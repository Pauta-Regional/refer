'-----------------------------------------------
' BetterBlockOut.vb (c) 2002 by Charles Petzold
'-----------------------------------------------
Imports System
Imports System.Drawing
Imports System.Windows.Forms

Class BetterBlockOut
    Inherits Form
    ...
    Protected Overrides Sub OnMouseMove(ByVal mea As MouseEventArgs)
        If bBlocking AndAlso (mea.Button And MouseButtons.Left) <> 0 Then
            Dim grfx As Graphics = CreateGraphics()
    ...
    Protected Overrides Sub OnKeyPress(ByVal kpea As KeyPressEventArgs)
        If bBlocking AndAlso kpea.KeyChar = Chr(27) Then
            Dim grfx As Graphics = CreateGraphics()
            grfx.DrawRectangle(New Pen(BackColor), Rect(ptBeg, ptEnd))
            grfx.Dispose()
            bBlocking = False
